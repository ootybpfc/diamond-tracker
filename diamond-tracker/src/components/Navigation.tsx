...
import { Home, CalendarDays, BookOpen, Users, Target } from 'lucide-react';
...
export function TopNav() {
  return (
    <nav className="hidden sm:flex items-center justify-center gap-1 h-14 border-b border-border bg-surface/80 backdrop-blur-lg sticky top-0 z-40">
      {tabs.map(({ to, label, icon: Icon }) => (
        <NavLink
          key={to}
          to={to}
